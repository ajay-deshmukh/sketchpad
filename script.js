...
class Sketchpad {
  /*
        The sketchpad maintains the current state of the sketchpad such as the current tool being used, the color, and the size.
    */
  ...
  handleText() {
    /* Add the event listeners needed for the text tool to work and  reset the text inside the text tool input      */
    textToolInput.innerText = "";
  ...
  init() {
    /* Initialize the canvas event listeners that allows for drawing to take place as well as set the canvas height and width   */
